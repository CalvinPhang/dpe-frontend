...
const SoldTable = ( {containers}: any) => {
  ...
  return (  
    <>
      <DataTable value={containers} stripedRows tableStyle={{ minWidth: '50rem' }} paginator rows={10} filterDisplay='row' 
        // dataKey='id' filters={filters}  selection={selected_products!} onSelectionChange={(e) => select_products(e.value)}
        >
